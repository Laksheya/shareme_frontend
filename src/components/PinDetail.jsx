...
const PinDetail = () => {
  ...
  const addComment = () => {
    if (comment) {
      ...
      axios.put('http://localhost:4000/api/v1/pins/addComment', {
        comment,
        pinId,
        userId: user._id
      }).then((res) => {
        ...
        axios
          .get(`http://localhost:4000/api/v1/pins/getPinDetail/${pinId}`)
          .then((res) => {
  ...
  useEffect(() => {
    if (pinDetail) {
      axios
        .get(`http://localhost:4000/api/v1/user/getUserInfo/${pinDetail.postedBy}`)
        .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/api/v1/pins/getComments/${pinId}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/api/v1/pins/getSimilarPins/${pinDetail?.category}`)
      .then((res) => {
